...
*/
    int ORBmatcher::SearchForInitialization(Frame &F1, Frame &F2, vector<int> &vnMatches12, int windowSize)
    {
        ...
        //cout<<"F1.mGroundMat:"<<F1.mGroundMat.size()<<" F1.mvKeysUn.size():"<<F1.mvKeysUn.size()<<endl;
		//cout<<"F2.mGroundMat:"<<F2.mGroundMat.size()<<" F2.mvKeysUn.size():"<<F2.mvKeysUn.size()<<endl;
...
int ORBmatcher::SearchForLidarGroundCloud(Frame &F1, Frame &F2, vector<int> &vnMatches12, int windowSize)
    {
        int nmatches=0;
        vnMatches12 = vector<int>(F1.mvKeysUn.size(),-1);
